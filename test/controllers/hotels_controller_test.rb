...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { address: @hotel.address, hotelname: @hotel.hotelname, phone: @hotel.phone, website: @hotel.website }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { address: @hotel.address, hotelname: @hotel.hotelname, phone: @hotel.phone, website: @hotel.website }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
